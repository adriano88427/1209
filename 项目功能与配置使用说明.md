...
- 检验/审计类（`baogao/jianyan/`，需要时再查看）：`factor_analysis_log_*.txt`、`log_metrics.csv`、`ic_diff.csv`、`ic_stats_compare.csv`、`audit_summary_latest.csv`、`ic_benchmark_external_pandas.csv`、`ic_benchmark_compare_pandas.csv`、`ic_selfcheck_compare.csv`、`ic_bootstrap_ci.csv` 等。
